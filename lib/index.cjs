var $48LKp$hollowdb = require("hollowdb");
var $48LKp$warpcontractsplugindeploy = require("warp-contracts-plugin-deploy");
var $48LKp$heapjs = require("heap-js");
var $48LKp$protobufjsminimal = require("protobufjs/minimal");
...
$parcel$export(module.exports, "DriaCompatSDK", () => $30cf9036313180b9$export$8976759926bdf684);
$parcel$export(module.exports, "default", () => $30cf9036313180b9$export$2e2bcd8739ae039);


class $fb2defd7cf6b0236$export$40b5ebc2b6c53be8 extends (0, $48LKp$heapjs.Heap) {
    constructor(elems = []){
        super($fb2defd7cf6b0236$export$5da954c098483040);
        if (elems.length !== 0) super.addAll(elems);
    }
}
function $fb2defd7cf6b0236$export$5da954c098483040(a, b) {
    return a[0] - b[0];
}
function $fb2defd7cf6b0236$export$88d1b1b3b8e9de14(a, b) {
    return a.reduce((sum, val, idx)=>sum + val * b[idx], 0);
}
function $fb2defd7cf6b0236$export$1991ecd29cc92c6b(a) {
    return Math.sqrt(a.reduce((sum, val)=>sum + val * val, 0));
}
function $fb2defd7cf6b0236$export$b529292445965cab(a, b) {
    return 1 - $fb2defd7cf6b0236$export$88d1b1b3b8e9de14(a, b) / ($fb2defd7cf6b0236$export$1991ecd29cc92c6b(a) * $fb2defd7cf6b0236$export$1991ecd29cc92c6b(b));
}
function $fb2defd7cf6b0236$export$2af647116e455992(a, b) {
    return $fb2defd7cf6b0236$export$88d1b1b3b8e9de14(a, b);
}
function $fb2defd7cf6b0236$export$eda62639d7a2a8a8(a, b) {
    return Math.sqrt(a.reduce((sum, val, idx)=>sum + Math.pow(val - b[idx], 2), 0));
}


class $d7157265a681942a$export$179858115d652742 {
     ...
     */ async insert(q, metadata) {
        ...
        if (ep_index !== null) {
            const dist = (0, $fb2defd7cf6b0236$export$b529292445965cab)(q, await this.db.get_point(ep_index));
     ...
     */ async search_layer(q, ep, ef, l_c) {
        ...
        const C = new (0, $fb2defd7cf6b0236$export$40b5ebc2b6c53be8)(ep);
        ...
        const W = new (0, $fb2defd7cf6b0236$export$40b5ebc2b6c53be8)(ep.map(([mdist, p])=>[
                -mdist,
                p
            ]));
        while(!C.isEmpty()){
            ...
            const dists = points.map((p)=>(0, $fb2defd7cf6b0236$export$b529292445965cab)(p, q));
        ...
        if (ef === 1) {
            if (W.length !== 0) {
                ...
                const dd = new (0, $fb2defd7cf6b0236$export$40b5ebc2b6c53be8)(W.heapArray.map((W_i)=>[
                        -W_i[0],
                        W_i[1]
                    ]));
                return [
     ...
     */ select_neighbors(q, C, l_c, keepPrunedConnections = true) {
        const R = new (0, $fb2defd7cf6b0236$export$40b5ebc2b6c53be8)();
        const W = new (0, $fb2defd7cf6b0236$export$40b5ebc2b6c53be8)(C);
        const M = l_c > 0 ? this.m : this.m_max0; // number of neighbors to return
        const W_d = new (0, $fb2defd7cf6b0236$export$40b5ebc2b6c53be8)(); // queue for discarded candidates
    ...
    /** K-nearest Neighbor search. */ async knn_search(q, K) {
        ...
        ep.sort((0, $fb2defd7cf6b0236$export$5da954c098483040));
...
// Common aliases
var $fc0d78ec1104c501$var$$Reader = $48LKp$protobufjsminimal.Reader, $fc0d78ec1104c501$var$$Writer = $48LKp$protobufjsminimal.Writer, $fc0d78ec1104c501$var$$util = $48LKp$protobufjsminimal.util;
// Exported root namespace
var $fc0d78ec1104c501$var$$root = $48LKp$protobufjsminimal.roots["default"] || ($48LKp$protobufjsminimal.roots["default"] = {});
$fc0d78ec1104c501$var$$root.index_buffer = function() {
    /**
    ...
    index_buffer.LayerNode = function() {
         ...
         * @memberof index_buffer.LayerNode
         * @instance
         */ LayerNode.prototype.neighbors = $fc0d78ec1104c501$var$$util.emptyObject;
        /**
         ...
         */ LayerNode.encode = function encode(message, writer) {
            if (!writer) writer = $fc0d78ec1104c501$var$$Writer.create();
         ...
         */ LayerNode.decode = function decode(reader, length) {
            if (!(reader instanceof $fc0d78ec1104c501$var$$Reader)) reader = $fc0d78ec1104c501$var$$Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $fc0d78ec1104c501$var$$root.index_buffer.LayerNode(), key, value;
            while(reader.pos < end){
                ...
                switch(tag >>> 3){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        if (message.neighbors === $fc0d78ec1104c501$var$$util.emptyObject) message.neighbors = {};
         ...
         */ LayerNode.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $fc0d78ec1104c501$var$$Reader)) reader = new $fc0d78ec1104c501$var$$Reader(reader);
         ...
         */ LayerNode.verify = function verify(message) {
            ...
            if (message.level != null && message.hasOwnProperty("level")) {
                if (!$fc0d78ec1104c501$var$$util.isInteger(message.level)) return "level: integer expected";
            }
            if (message.idx != null && message.hasOwnProperty("idx")) {
                if (!$fc0d78ec1104c501$var$$util.isInteger(message.idx)) return "idx: integer expected";
            }
            ...
            if (message.neighbors != null && message.hasOwnProperty("neighbors")) {
                if (!$fc0d78ec1104c501$var$$util.isObject(message.neighbors)) return "neighbors: object expected";
                var key = Object.keys(message.neighbors);
                for(var i = 0; i < key.length; ++i){
                    if (!$fc0d78ec1104c501$var$$util.key32Re.test(key[i])) return "neighbors: integer key{k:uint32} expected";
         ...
         */ LayerNode.fromObject = function fromObject(object) {
            if (object instanceof $fc0d78ec1104c501$var$$root.index_buffer.LayerNode) return object;
            var message = new $fc0d78ec1104c501$var$$root.index_buffer.LayerNode();
         ...
         */ LayerNode.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $48LKp$protobufjsminimal.util.toJSONOptions);
        };
        /**
    ...
    index_buffer.Point = function() {
         ...
         * @memberof index_buffer.Point
         * @instance
         */ Point.prototype.v = $fc0d78ec1104c501$var$$util.emptyArray;
        /**
         ...
         */ Point.decode = function decode(reader, length) {
            if (!(reader instanceof $fc0d78ec1104c501$var$$Reader)) reader = $fc0d78ec1104c501$var$$Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $fc0d78ec1104c501$var$$root.index_buffer.Point();
            while(reader.pos < end){
                var tag = reader.uint32();
                switch(tag >>> 3){
                    case 1:
         ...
         */ Point.fromObject = function fromObject(object) {
            if (object instanceof $fc0d78ec1104c501$var$$root.index_buffer.Point) return object;
            var message = new $fc0d78ec1104c501$var$$root.index_buffer.Point();
            if (object.idx != null) message.idx = object.idx >>> 0;
            if (object.v) {
    ...
    index_buffer.PointQuant = function() {
         ...
         * @memberof index_buffer.PointQuant
         * @instance
         */ PointQuant.prototype.v = $fc0d78ec1104c501$var$$util.emptyArray;
        /**
         ...
         */ PointQuant.decode = function decode(reader, length) {
            if (!(reader instanceof $fc0d78ec1104c501$var$$Reader)) reader = $fc0d78ec1104c501$var$$Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $fc0d78ec1104c501$var$$root.index_buffer.PointQuant();
            while(reader.pos < end){
                var tag = reader.uint32();
                switch(tag >>> 3){
                    case 1:
         ...
         */ PointQuant.verify = function verify(message) {
            ...
            if (message.v != null && message.hasOwnProperty("v")) {
                if (!Array.isArray(message.v)) return "v: array expected";
                for(var i = 0; i < message.v.length; ++i)if (!$fc0d78ec1104c501$var$$util.isInteger(message.v[i])) return "v: integer[] expected";
            }
            return null;
        };
        /**
         ...
         */ PointQuant.fromObject = function fromObject(object) {
            if (object instanceof $fc0d78ec1104c501$var$$root.index_buffer.PointQuant) return object;
            var message = new $fc0d78ec1104c501$var$$root.index_buffer.PointQuant();
            if (object.idx != null) message.idx = object.idx >>> 0;
            if (object.v) {
...
$fc0d78ec1104c501$exports = $fc0d78ec1104c501$var$$root;


function $2be999e8825eb13a$export$19d9b04acf01a618(q) {
    const qe = (0, $fc0d78ec1104c501$exports.index_buffer).Point.encode(q).finish();
    return Buffer.from(qe).toString("base64");
}
function $2be999e8825eb13a$export$48b31e59a75600e9(data) {
    const dec = Buffer.from(data, "base64");
    return (0, $fc0d78ec1104c501$exports.index_buffer).Point.decode(dec);
}
function $2be999e8825eb13a$export$a74fc3f6840de7c5(n) {
    const ne = (0, $fc0d78ec1104c501$exports.index_buffer).LayerNode.encode({
        ...n,
        visible: n.visible || true
    }).finish();
    return Buffer.from(ne).toString("base64");
}
function $2be999e8825eb13a$export$f7d4ebdd56cd2d02(data) {
    const dec = Buffer.from(data, "base64");
    return (0, $fc0d78ec1104c501$exports.index_buffer).LayerNode.decode(dec);
}


/** Utilities to get the key in KVdb for a value. */ const $98018e7b5cadbd66$export$ed97f33186d4b816 = {
    layers: "layers",
    ep: "ep",
    points: "points",
    metadata: (idx)=>`m:${idx}`,
...
function $98018e7b5cadbd66$export$b48ee232557adc37(data) {
    return data ? JSON.parse(data) : null;
}


class $3fce1f13aa2e9c3a$export$88f737c73cf982cd {
    /**
    ...
    async get_ep() {
        const ep = await this.client.get((0, $98018e7b5cadbd66$export$ed97f33186d4b816).ep);
        return ep === null ? null : parseInt(ep);
    }
    async set_ep(ep) {
        await this.client.set((0, $98018e7b5cadbd66$export$ed97f33186d4b816).ep, ep.toString());
    }
    async get_point(idx) {
        const data = await this.client.get((0, $98018e7b5cadbd66$export$ed97f33186d4b816).point(idx));
        if (!data) throw new Error(`No point with index ${idx}`);
        const point = (0, $2be999e8825eb13a$export$48b31e59a75600e9)(data);
        return point.v;
    }
    async get_points(idxs) {
        if (idxs.length === 0) return [];
        const datas = await this.safe_get_many(idxs.map((idx)=>(0, $98018e7b5cadbd66$export$ed97f33186d4b816).point(idx)));
        ...
        const points = datas.map((data)=>(0, $2be999e8825eb13a$export$48b31e59a75600e9)(data));
        return points.map((point)=>point.v);
    }
    async new_point(q) {
        const idx = await this.get_datasize();
        const point = (0, $2be999e8825eb13a$export$19d9b04acf01a618)({
            v: q,
            idx: idx
        });
        await this.client.set((0, $98018e7b5cadbd66$export$ed97f33186d4b816).point(idx), point);
        await this.client.set((0, $98018e7b5cadbd66$export$ed97f33186d4b816).points, (idx + 1).toString());
        return idx;
    }
    async get_num_layers() {
        const numLayers = await this.client.get((0, $98018e7b5cadbd66$export$ed97f33186d4b816).layers);
        return numLayers ? parseInt(numLayers) : 0;
    }
    async get_datasize() {
        const datasize = await this.client.get((0, $98018e7b5cadbd66$export$ed97f33186d4b816).points);
        return datasize ? parseInt(datasize) : 0;
    }
    async get_neighbor(layer, idx) {
        const data = await this.client.get((0, $98018e7b5cadbd66$export$ed97f33186d4b816).neighbor(layer, idx));
        if (!data) throw new Error(`No neighbors at layer ${layer}, index ${idx}"`);
        const node = (0, $2be999e8825eb13a$export$f7d4ebdd56cd2d02)(data);
        return node.neighbors;
    }
    async get_neighbors(layer, idxs) {
        const datas = await this.safe_get_many(idxs.map((idx)=>(0, $98018e7b5cadbd66$export$ed97f33186d4b816).neighbor(layer, idx)));
        // see if there is a null value in there
        const nullPos = datas.indexOf(null);
        if (nullPos !== -1) throw new Error(`No neighbors at layer ${layer}, index ${idxs[nullPos]}"`);
        const nodes = datas.map((data)=>(0, $2be999e8825eb13a$export$f7d4ebdd56cd2d02)(data));
    ...
    async upsert_neighbor(layer, idx, node) {
        const data = (0, $2be999e8825eb13a$export$a74fc3f6840de7c5)({
            idx: idx,
            level: layer,
            neighbors: node
        });
        await this.client.set((0, $98018e7b5cadbd66$export$ed97f33186d4b816).neighbor(layer, idx), data);
    }
    async upsert_neighbors(layer, nodes) {
        await this.safe_set_many(Object.keys(nodes).map((idx)=>{
            const i = parseInt(idx);
            const key = (0, $98018e7b5cadbd66$export$ed97f33186d4b816).neighbor(layer, i);
            const value = (0, $2be999e8825eb13a$export$a74fc3f6840de7c5)({
                idx: i,
                level: layer,
                neighbors: nodes[i]
            });
    ...
    async new_neighbor(idx) {
        ...
        await this.client.set((0, $98018e7b5cadbd66$export$ed97f33186d4b816).layers, (l + 1).toString());
    }
    async get_metadata(idx) {
        const data = await this.client.get((0, $98018e7b5cadbd66$export$ed97f33186d4b816).metadata(idx));
        return (0, $98018e7b5cadbd66$export$b48ee232557adc37)(data);
    }
    ...
    async set_metadata(idx, data) {
        await this.client.set((0, $98018e7b5cadbd66$export$ed97f33186d4b816).metadata(idx), JSON.stringify(data));
    }
    /**
...
class $30cf9036313180b9$export$8976759926bdf684 extends (0, $48LKp$hollowdb.SetSDK) {
...
class $30cf9036313180b9$export$2e2bcd8739ae039 extends (0, $d7157265a681942a$export$179858115d652742) {
    /**
     ...
     */ constructor(hollowdb, options){
        ...
        super(new (0, $3fce1f13aa2e9c3a$export$88f737c73cf982cd)(hollowdb), m, ef_construction, ef_search);
        this.sdk = hollowdb;
    }
     ...
     */ static async deploy(wallet, warp) {
        ...
        const { srcTxId: deploymentSrcTxId, contractTxId: contractTxId } = await warp.deployFromSourceTx({
            wallet: new (0, $48LKp$warpcontractsplugindeploy.ArweaveSigner)(wallet),
            initState: JSON.stringify(initialState),
            srcTxId: srcTxId,
            evaluationManifest: {
                evaluationOptions: {
